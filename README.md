...
**`bc-shamir-ts`** implements Shamir's Secret Sharing over GF(256), the sharding primitive underneath SSKR.
...
[@blockchaincommons/shamir](https://www.npmjs.com/package/@blockchaincommons/shamir) is published to npm. Install it with your package manager of choice:

```sh
npm install @blockchaincommons/shamir
# or
pnpm add @blockchaincommons/shamir
# or
yarn add @blockchaincommons/shamir
# or
bun add @blockchaincommons/shamir
```
...
// Shares are frozen objects; pass a seeded generator for reproducible splits.
Object.isFrozen(shares[0]); // true
```
...
`bc-shamir-ts` is currently under active development and in beta testing. It should not be used for production tasks until it has had further testing and auditing. See [Blockchain Commons' Development Phases](https://github.com/BlockchainCommons/Community/blob/master/release-path.md).
...
`@blockchaincommons/shamir` depends on `@blockchaincommons/crypto`, `@blockchaincommons/rand` at runtime.
...
This `bc-shamir-ts` project is either derived from or was inspired by:
...
As an open-source, open-development community, Blockchain Commons does not have the resources to provide direct support of our projects. Please consider the discussions area as a locale where you might get answers to questions. Alternatively, please use this repository's [issues](https://github.com/BlockchainCommons/bc-shamir-ts/issues) feature. Unfortunately, we can not make any promises on response time.
